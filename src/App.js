...
function App() {
  ...
  return (
    <div className="App bg-dark">
      ...
      <Header />
      <Form handleChange={handleChange} handleSubmit={addToDo} value={taskInput} updateToDo={updateToDo} />
      <List toDo={toDo} handleCompleted={handleCompleted} handleDelete={handleDelete} handleEdit={handleEdit} />
    </div>
  );
}
export default App;
